...
enums.ReaffirmationDtoFont reaffirmationDtoFontFromJson(
  ...
  return enums.$ReaffirmationDtoFontMap.entries
      .firstWhere(
          (element) =>
              element.value.toLowerCase() == reaffirmationDtoFont.toLowerCase(),
