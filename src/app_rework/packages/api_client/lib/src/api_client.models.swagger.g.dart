...
ReaffirmationDto _$ReaffirmationDtoFromJson(Map<String, dynamic> json) =>
    ReaffirmationDto(
      id: (json['id'] as num?)?.toDouble(),
      uiId: json['uiId'] as String?,
      font: reaffirmationDtoFontFromJson(json['font'] as String?),
      stamp: reaffirmationDtoStampFromJson(json['stamp'] as String?),
      value: reaffirmationDtoValueFromJson(json['value'] as String?),
...
UserDto _$UserDtoFromJson(Map<String, dynamic> json) => UserDto(
      ...
      affirmations: (json['affirmations'] as List<dynamic>?)
          ...
          [],
      letterSchedule:
          userDtoLetterScheduleFromJson(json['letterSchedule'] as String?),
